import { h as head, b as stringify } from './index-CSxFwnw_.js';
import { B as Bottom, T as Tags, S as Starts } from './Starts-tbyzCZrp.js';
import { B as Button, b as btn } from './Icon-DSSx7BZD.js';
...
function Hero($$renderer) {
  ...
  $$renderer.push(`<!----></div></div> <div class="lg:w-[50%] w-full lg:h-auto h-auto lg:mb-0 flex flex-row gap-0 justify-center items-center relative"><img src="/images/left.webp" alt="Server Photos" class="bounce bounce-left absolute left-0.5 lg:block hidden"/> <img src="/images/right.webp" alt="Server Photos" class="bounce bounce-right absolute right-0.5 lg:block hidden"/> <img src="/images/top.webp" alt="Server Photos" class="bounce bounce-left w-30 rotate-24 absolute left-1/2 top-1/2 lg:hidden block"/> <img src="/images/bottom.webp" alt="Server Photos" class="bounce bounce-right w-30 rotate-24 absolute right-1/2 top-1/2 lg:hidden block"/></div></section>`);
}
...
securing enterprise workloads, or pushing research boundaries.`;
  ...
  Card2($$renderer, {
    ...
    image: "/images/Illustration9.webp"
  });
  $$renderer.push(`<!----> `);
  Card2($$renderer, {
    title: "Lease Reserved GPUs",
    content: "Access enterprise-grade GPUs (A100, H100, L40) in pre-configured racks.",
    image: "/images/Illustration10.webp"
  });
  ...
  Card2($$renderer, {
    ...
    image: "/images/Illustration11.webp"
  });
  $$renderer.push(`<!----> <div class="flex flex-col gap-4"><img src="/images/Syaala.webp" class="min-w-full w-[110%]" alt=""/> `);
  Card2($$renderer, {
    title: "24/7 Monitoring & Support",
    content: "Remote hands, uptime dashboards, and smart power metering at your fingertips.",
    image: "/images/Illustration12.webp"
  });
  $$renderer.push(`<!----></div> `);
  Card2($$renderer, {
    title: "Predictable Monthly Rates",
    content: "Fixed pricing by rack, kW, or GPU no surprise spikes.",
    image: "/images/Illustration13.webp"
  });
  $$renderer.push(`<!----></div></section> <section class="w-full flex flex-col gap-8">`);
  Starts($$renderer, {
...
//# sourceMappingURL=_page.svelte-BKC6eu_6.js.map
